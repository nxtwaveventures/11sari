                    ...
                    <div className="container">
                        ...
                        <div className="faq-grid">
                            <div className="faq-item">
                                <h3>Can I machine wash my Ayurvedic saree?</h3>
                                <p>
                            ...
                            <div className="faq-item">
                                <h3>Will the natural dyes fade over time?</h3>
                                <p>
                            ...
                            <div className="faq-item">
                                <h3>How often should I air my stored sarees?</h3>
                                <p>
                            ...
                            <div className="faq-item">
                                <h3>Can I iron my naturally dyed garments?</h3>
                                <p>
                                    Yes, but use caution. Iron on low to medium heat and preferably place a thin cotton cloth
                                    between the iron and your garment. Excessive heat can affect the natural dyes and their
                                    therapeutic properties. Steam ironing is particularly beneficial for naturally dyed silk.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="contact-content">
                            ...
                            <div className="contact-buttons">
                                <a href="mailto:care@11sari.com" className="btn btn-outline">Email Us</a>
                                <a href="tel:+919876543210" className="btn btn-gold">Call: +91 98765 43210</a>
                            </div>
                        </div>
                    </div>
                </div>
